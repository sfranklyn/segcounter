 ...
 *         &lt;element ref="{http://www.galileoindonesia.com/schema/PNR}ROE"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "RateOfExchangeMod")
public class RateOfExchangeMod implements Serializable
{

    @XmlElement(name = "UniqueKey", required = true)
    protected String uniqueKey;
    @XmlElement(name = "ROE", required = true)
