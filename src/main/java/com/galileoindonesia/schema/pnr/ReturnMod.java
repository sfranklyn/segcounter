 ...
 *         &lt;element ref="{http://www.galileoindonesia.com/schema/PNR}ReverseInd"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ReturnMod")
public class ReturnMod implements Serializable
{

    @XmlElement(name = "BIC", required = true)
    protected String bic;
    @XmlElement(name = "ReverseInd", required = true)
